...
// slash '/'. Any sequence of periods that does not match the rules above should
// be treated as a valid directory or file name. For example, '...' and '....'
// are valid directory or file names. The simplified canonical path should
// follow these rules:
...
// denote current or parent directories. Return the simplified canonical path.
